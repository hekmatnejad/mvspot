...
namespace spot
{
  ...
  public:
    ...
    /// If no satsolver is provided through SPOT_SATSOLVER en var, a
    ...
    /// \brief Returns non zero if the litteral is a failed assumption.
    /// Must only be used with distributed picolib.
    int failed_assumption(int lit);
  ...
  private:  // variables
    ...
    // The next 3 pointers will be != nullptr if SPOT_SATSOLVER is given.
